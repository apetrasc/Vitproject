...
if type(fl) == int:
    ...
    pred_fld='/mimer/NOBACKUP/groups/kthmech/sadanori/01_Ret180/02_vit/.predictions/NN_WallReconfluct1TF2_3NormIn-3Out_1-15_432x432_Ret180_lr0.001_decay20drop0.5_relu-1732884982/saved_model/pred_fluct0000.npz'
...
u_pred = u_pred
u_test = u_test
print(f"Loading test data and predictions from: {pred_fld}")
