...
class NN_WallRecon:
    ...
    CUR_PATH = '/mimer/NOBACKUP/groups/kthmech/sadanori/01_Ret180/02_vit'
    ## Ret180
    ...
    TIMESTAMP = '1732884982'  # add some information here to recognize the model
    
    FROM_CKPT = False     # to load the model saved at checkpoint CKPT
    CKPT = 5
